...
//Constructor
Christofides::Christofides(string in, string out){
	iFile = in;
	oFile = out;
...
int Christofides::get_distance(struct Christofides::City c1, struct Christofides::City c2){
...
int Christofides::getMinIndex(int key[], bool mst[]) {
